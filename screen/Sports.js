...
export default function Sports({navigation}) {
    ...
    const fetchNewsHeadlines = async () => {
      try {
        const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=cc7fcf60d59944aaa8984902b3e1030b');
        ...
        {!isLoading ? (
          <>
            ...
            <View style={styles.newshead}>
              <Text style={styles.sectiontxt}>Sports</Text>
            </View>
            <ScrollView>
            {headlines
