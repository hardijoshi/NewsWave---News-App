...
export default function Science({navigation}) {
    ...
    const fetchNewsHeadlines = async () => {
      try {
        const response = await fetch('https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=cc7fcf60d59944aaa8984902b3e1030b');
        ...
        {!isLoading ? (
          <>
            ...
            <View style={styles.newshead}>
              <Text style={styles.sectiontxt}>Science</Text>
            </View>
            <ScrollView>
            {headlines
